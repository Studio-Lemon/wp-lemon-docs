...
| <span class="hook-name"><code>WP_Lemon\Controllers\Analytics\body_open_tagmanager</code></span> | <span class="hook-priority">9</span> | <span class="hook-description">Outputs the tagmanager code right after the body tag opens</span> |
| <span class="hook-name"><code>WP_Lemon\Controllers\A11y\skip_links</code></span> | <span class="hook-priority">10</span> | <span class="hook-description">Outputs the skip links</span> |
...
| Name | Type | Description |
| --- | --- | --- |
| $holder_classes | `string` | The holder classes for the loop.  `$card_type` The card type dynamically set. |
...
| Name | Type | Description |
| --- | --- | --- |
| $holder_classes | `string` | The holder classes for the loop.  `$card_type` The card type dynamically set in the block.  var |
