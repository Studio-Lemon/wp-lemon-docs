...
`latest_items_query( string $type, int $amount = 2, ?array $predefined_posts = null, ?string $taxonomy = null, ?array $term_ids = null, array<string, mixed>|bool|null $extra_args = null )`
...
`get_total_posts( string $post_type, int $loaded_posts = 0, ?string $taxonomy = null, ?array $term = null, ?array $extra_args = null )`
