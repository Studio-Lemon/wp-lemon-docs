...
The naming of filters got a massive overhaul. Please double check our [filters chapter](/docs/extend/hooks#filter-examples) and triple-check if your filters need to be updated and work as intended.
