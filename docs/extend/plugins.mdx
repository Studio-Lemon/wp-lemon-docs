...
### Lemon Glossary (lemon-glossary)

The Lemon Glossary plugin adds glossary functionality to your wp-lemon project, so you can manage and display glossary items in a structured way.
...
```bash
composer require satispress/lemon-glossary
wp plugin activate lemon-glossary
```
