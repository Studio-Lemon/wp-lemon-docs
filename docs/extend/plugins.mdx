...
```bash
composer require satispress/searchwp
composer require satispress/lemon-faq
wp plugin activate searchwp
wp plugin activate lemon-faq
```
Optionally, you can install the SearchWP related plugins, to show related other questions
```bash
composer require satispress/searchwp-related
wp plugin activate searchwp-related
```

### Lemon Glossery (lemon-glossery)

The Lemon Glossery plugin adds glossary functionality to your wp-lemon project, so you can manage and display glossary items in a structured way.

**Features:**

- Adds dedicated glossary functionality for wp-lemon projects
- Loads only when the wp-lemon theme is available
- Includes update support through the Studio Lemon GitHub releases

**Installation:**

```bash
composer require satispress/lemon-glossery
wp plugin activate lemon-glossery
```
