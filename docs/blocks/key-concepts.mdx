...
Find out how you can easily create your own block right [here](/docs/blocks/create-block).
...
Read more about all the possibilities in your block declaration file right [here](/docs/blocks/block-declaration).
...
There is a lot that goes into your controller layer so you'll definitely want to check out our detailed documentation right [here](/docs/blocks/block-controller).
...
Read more about the possibilities right [here](/docs/blocks/block-view).

## Time to get started
Now that you get the global idea of building blocks in wp-lemon you can easily get started by creating your own block.
To do this just follow the steps described right [here](/docs/blocks/create-block).