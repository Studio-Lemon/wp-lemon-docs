...
To learn how to use InnerBlocks, take a look at the [InnerBlocks documentation](/docs/blocks/innerblocks).
...
To learn how to use these fields in your block view, take a look at the [block view documentation](/docs/blocks/block-view).

## Extending the block context

Every block is different but we will give some common examples on how to expand your block. Please also take a look at the [BlockRenderer documentation](https://levdbas.github.io/Bulldozer/#/reference/highground-bulldozer-blockrendererv2) for more functions you can use in your block context.
