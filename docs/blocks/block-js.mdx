...
For example, if you have a block called `hero`, you'll find a `index.js` file in the `blocks/hero/` directory.
...
You can find the full documentation for these functions in the [JavaScript Functions Reference](/docs/reference/javascript-functions).
