...
Once downloaded you can add the fonts to the resources/assets/fonts/FONTNAME folder and include the generated stylesheet to `resources/assets/style/01-settings/_fonts.scss`
...
When you've added your font you will now have to add the font variables in your `_variables.scss`. Read [basic styling](/docs/basics/basic-styling) for more information about overwriting variables.
