...
## wp-lemon/action/block/node-latest/\{$card_type\}/loop/before
...
## wp-lemon/action/block/node-latest/\{$card_type\}/loop/after
...
## wp-lemon/action/card/\{$card_type\}/before
...
## wp-lemon/action/card/\{$card_type\}/after
...
## wp-lemon/action/block/node-overview/\{$card_type\}/loop/before
...
## wp-lemon/action/block/node-overview/\{$card_type\}/loop/after
...
## wp-lemon/action/entry-header/\{$post_type\}/title/before
...
## wp-lemon/action/entry-header/\{$post_type\}/title/after
...
## wp-lemon/action/entry-header/\{$post_type\}/tags/after
...
## wp-lemon/action/entry-header/\{$post_type\}/picture/after
