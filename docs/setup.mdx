...
wp-lemon is a [npx package](https://www.npmjs.com/package/wp-lemon) hosted on npm.com to do all the heavy lifting for you. Just run the package, fill in some variables and get yourself a cup of coffee and voilla!
...
- wp-cli dotenv package installed ([How to install](https://github.com/aaemnnosttv/wp-cli-dotenv-command))
...
After adding this folder you can open a new terminal inside this folder and run the following command `npx wp-lemon` to run the cli-tool. This will automatically download the latest version of this package and starts the installation process. You will now want to follow the instructions given by the cli-tool itself.

> 💡
> Accept default values by pressing enter.

Feedback? Create a ticket at [GitHub](https://github.com/Studio-Lemon/wp-lemon/issues).
