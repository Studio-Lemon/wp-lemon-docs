...
You can also deregister existing post types via `library/models/modify-post-types.php`. This is useful when you don't need the default post types like `news` or `person` for example.
