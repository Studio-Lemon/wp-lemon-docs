...
2. Make a production build in your child theme by running `yarn run production`.
3. Remove both wp-lemon and child theme folders from the server.
4. Upload both wp-lemon and child theme folders
5. **Empty cache.**
