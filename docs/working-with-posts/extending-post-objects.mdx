...
add_filter(
	...
	function ($classmap) {
		$custom_classmap = [
			...
			'news'           => News::class,
			'post-education' => PostEducation::class,
...
For more documentation on how to use them within your block context take a look at the [block context documentation](/docs/blocks/block-controller).
