...
|--------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------|
| wp-lemon/filter/socials_order                                | Change the default order of the socials in blocks, headers and footers.                                                                                          |
...
| wp-lemon/filter/card/{{card_type}}/excerpt_length            | Change the excerpt length inside a specific cards                                                                           |
...
| wp-lemon/no_items_message/{{block_slug}}/{{dynamic_post_type}}                         | Used in the node-latest block to change the message when no items are found that is shown to the site visitors.          |  
