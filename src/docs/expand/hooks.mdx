...
| wp-lemon/action/entry/entry-header/before       | Insert code after the the entry-header.twig file |
| wp-lemon/action/entry/entry-footer/before       | Insert code before the the entry-after.twig file |
...
| wp-lemon/action/footer-widgets-row/before | Insert code **before** actual widgets                                    |
| wp-lemon/action/footer-widgets-row/after | Insert code **after** actual widgets                                         |
...
| wp-lemon/action/block/node-latest/{{card_type}}/holder-classes         | Filter the holder classes                   |
| wp-lemon/filter/block/node-overview/{{dynamic_post_type}}/load-more-text | Change load more text. |
| wp-lemon/action/block/node-overview/{{card_type}}/holder-classes         | Filter the holder classes                   |
| wp-lemon/action/block/node-overview/{{card_type}}/items        | Filter the post array               |
| wp-lemon/action/block/node-overview/{{card_type}}/posts-per-page        | Filter the amount of posts to be loaded via Ajax             |
...
| wp-lemon/filter/entry-footer/{{post_type}}/share-label         | Change share heading label |
| wp-lemon/filter/entry-footer/{{post_type}}/share-platforms         | Filter the platform array to add/remove share platforms |
| wp-lemon/filter/entry-footer/{{post_type}}/show-share-buttons         | Whether to show the share buttons |
