...
| wp-lemon/filter/entry-footer/{{post_type}}/show-share-buttons         | Used to change the image id of the image in the entry-header.twig of a specific post type. Or set to false to remove it completely. |
