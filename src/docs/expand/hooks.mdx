...
|wp-lemon/filter/copyright-message     |    Returns the copyright message, use this to change the copyright message in the | | wp-lemon/filter/image_sizes    | Filters the image sizes inside all blocks that use image_sizes context variable |
