...
`Example_Block` class and active the class on the bottom of this file by uncommenting it. After that you can update the name, title, icon data. This file automatically gets loaded.
...
You can now add the block to a page and see if it works. Common things why the block doesn't work:
