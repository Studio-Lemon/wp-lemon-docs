...
Based on your design, you can figure out what blocks you can use to create the pages of your project. You can use the default set of blocks available in wp-lemon and you can create your own for unique blocks. You can read more about creating blocks in the [blocks guide](/extend/add-blocks).
