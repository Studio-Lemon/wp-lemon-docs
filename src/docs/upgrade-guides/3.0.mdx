...
### Step 3. import new dependencies in app.json
Navigate to resources/assets/scripts/app.json and locate the bootstrap imports at te top. Remove the util import and add the offcanvas import as shown in this code example.
...
### Step 5. Update icons
Open a new console in your child theme and run the following command: `yarn run update-iconfont`

This will update the local iconfont. Please make sure you re-add any icons you need.
