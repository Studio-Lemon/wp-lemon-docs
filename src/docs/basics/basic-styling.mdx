---
title: Styling your theme
description:  Style your child theme via variables.
---
...
The first things you'll want to do is to define your brand colors. Extract your theme/brand colors from the design document or handoff file and convert them to scss variables. I recommend using a tool like [Name that color (website)](https://chir.ag/projects/name-that-color/) or [Name that color (vs code extension)](https://marketplace.visualstudio.com/items?itemName=guillaumedoutriaux.name-that-color/) to transform colors into distinguishable names.

```scss title=resources/styles/01-settings/_variables.scss
