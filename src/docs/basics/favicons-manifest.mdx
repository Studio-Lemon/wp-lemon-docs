...
```php
WP_Lemon\Classes\Site_Icons::filter_favicon_path
```
...
use WP_Lemon\Classes\Site_Icons;
...
...
...
## Update prior to 2.4.5
The site icon class has been moved to Bulldozer since it's a universal class across all our projects. Please update the use statement in your site setup after you ran composer update in your root dir.
