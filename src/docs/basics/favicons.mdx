...
After generating your own set please plase them in `/web/app/themes/YOURCHILDTHEME/resources/favicons`.
...
checks if `site.webmanifest` is present in your new favicon folder. If so, your new generated files will be loaded instad of the default ones.
