...
description: How to deploy WP_Lemon on a new host.
---

This chapter will cover the initial deployment of WP_lemon on a new host.
...
└── web
    ...
    │   │    └── wp_lemon - do not upload dotfiles, yarn.lock, package.json, babel.config.json and the node_modules folder)
    │   └── uploads
    ├── wp-config.php
    ├── index.php
    └── wp
...
- Google search console is actived
