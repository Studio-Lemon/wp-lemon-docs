...
| wp-lemon/filter/header/breakpoint                            | Set the breakpoint on which the menu collapses. Can be xs,sm, md, lg,xl, xxl. Use it in combination with  ```scss $menu-breakpoints: (
	xs: 0,
	menu: 992px,
) !default;
