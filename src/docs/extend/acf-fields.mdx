...
When you've build your own custom block and want to add ACF fields you'll have to go trough a similar process, you can find more information on this  [here](/extend/add-blocks#block-with-custom-acf-fields).