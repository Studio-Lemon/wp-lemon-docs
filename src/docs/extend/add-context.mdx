...
|pages    | array   | Holds the important pages in wp-lemon as well as the archive pages that can be set via the customizer |
...
```
After that we add it to our extend_site_information method under a convinient key.
