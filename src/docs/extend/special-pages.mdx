...
In our website we van register and store special pages. But what would you classify as a special page? 
...
Links and page IDs are sensitive to error and there could be a dozen of reasons that could make a link break.
By marking a page a special page we create a link we can access globally in the backend. 
 ...
 *
 * @param array $pages
 * @return array $pages Updated array with special pages.
 */
...
After you've done this you can navigate to the Customizer in your cms. 
